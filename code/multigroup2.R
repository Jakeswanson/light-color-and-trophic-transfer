####### Code for piecewisesem multigroup from github issues forum that solved multigroup issues for some users
### I can't remember exactly who/where this code came from
